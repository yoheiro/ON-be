cordova.define('com.unarin.cordova.beacon.LocationManager', function (
  require,
  exports,
  module
) {
 ...
 */
  ...
  LocationManager.prototype._mapDelegateCallback = function (pluginResult) {
    ...
    this.appendToDeviceLog(
      '_mapDelegateCallback() found eventType ' + eventType
    );
   ...
   */
  LocationManager.prototype.startAdvertising = function (
    region,
    measuredPower
  ) {
    Regions.checkRegionType(region);
    if (measuredPower)
      return this._promisedExec(
        'startAdvertising',
        [region, measuredPower],
        []
      );
