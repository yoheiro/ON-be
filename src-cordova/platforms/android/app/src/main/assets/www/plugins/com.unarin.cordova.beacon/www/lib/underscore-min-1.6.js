cordova.define('com.unarin.cordova.beacon.underscorejs', function (
  require,
  exports,
  module
) {
  ...
  (function () {
    ...
    const O = 'Reduce of empty array with no initial value';
    ...
    const E = function (n) {
      return n == null ? j.identity : j.isFunction(n) ? n : j.property(n);
    };
    ...
    (j.isEqual = function (n, t) {
      ...
      (j.matches = function (n) {
        return function (t) {
          if (t === n) return !0;
          for (const r in n) if (n[r] !== t[r]) return !1;
          return !0;
        };
      }),
