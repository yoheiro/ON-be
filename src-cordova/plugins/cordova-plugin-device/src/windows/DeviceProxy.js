...
const DEVICE_CLASS_KEY_NO_SEMICOLON =
  '{A45C254E-DF1C-4EFD-8020-67D146A850E0}10';
const ROOT_CONTAINER_QUERY =
...
module.exports = {
  getDeviceInfo(win, fail, args) {
    ...
    if (localSettings.values.deviceId) {
      ...
      try {
        const ASHWID = Windows.System.Profile.HardwareIdentification.getPackageSpecificToken(
          null
        ).id;
    ...
    const devicePlatform = !userAgent.includes('MSAppHost/1.0')
      ? 'windows'
      : 'windows8';
    ...
    Pnp.PnpObject.findAllAsync(
      ...
      for (let i = 0; i < rootDevices.length; i++) {
