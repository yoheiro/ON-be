  ...
  function o(a, b, c) {
    ...
    if (
      ...
      e.state === 'rejected' && (d.exception = e.reason),
        (d.valueOf = function () {
          const a = c();
          return a.state === 'pending' || a.state === 'rejected' ? d : a.value;
        });
    }
    return d;
  }
  ...
  (k.resetUnhandledRejections = w),
    ...
    (k.nfbind = k.denodeify = function (a) {
      ...
      return function () {
        ...
        const d = l();
        return (
          c.push(d.makeNodeResolver()), k(a).fapply(c).fail(d.reject), d.promise
        );
      };
    }),
    ...
    (k.nbind = function (a, b) {
      ...
      return function () {
        ...
        const f = l();
        return (
          e.push(f.makeNodeResolver()), k(d).fapply(e).fail(f.reject), f.promise
        );
      };
    }),
